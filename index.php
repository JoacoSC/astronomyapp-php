    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-6 col-lg-2">
          <h1 class="mb-0 site-logo"><div class="text-center">
                    <img class="logo-fluid" src="img/logo_grande.png" alt="">
                </div></h1>
        </div>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-7 text-center text-lg-left">
              <h1 data-aos="fade-right">Bienvenido a Astronomyapp</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Lorem ipsum dolor sit amet, consectetur
                adipisicing elit.</p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="register.php" class="btn btn-outline-white">Empezar</a></p>
            </div>
            <div class="col-lg-5 iphone-wrap">
              <img src="img/astrono_1.png" alt="Image" class="phone-1" data-aos="fade-right">
              <img src="img/astrono_1.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
          </div>
        </div>
      </div>
