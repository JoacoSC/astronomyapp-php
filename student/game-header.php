...
<head>
    ...
    <link rel="shortcut icon" href="planetas/TemplateData/favicon.ico">
    <link rel="stylesheet" href="planetas/TemplateData/style.css">
    <script src="planetas/TemplateData/UnityProgress.javascript"></script>
    <script src="planetas/Build/UnityLoader.js"></script>
    <script>
        var gameInstance = UnityLoader.instantiate("gameContainer", "planetas/Build/planetas.json", {onProgress: UnityProgress});
    </script>
