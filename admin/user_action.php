...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			if($row["user_status"] == 'Enable')
			{
				...
				$status = '<button type="button" name="status_button" class="btn btn-primary btn-sm">Habilitado</button>';
			}
			else
			{
				...
				$status = '<button type="button" name="status_button" class="btn btn-danger btn-sm">Deshabilitado</button>';
			}
			$sub_array[] = $status;
			$sub_array[] = '
			<div align="center">
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Datos de usuario actualizados</div>';
		}
