    	...
    	<form method="post" id="user_form" enctype="multipart/form-data">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Crear usuario</h4>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Teléfono<span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Foto de perfil</label>
                            <div class="col-md-8">
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text('Editar datos de usuario');
